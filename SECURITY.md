...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/semitexa-weave/security/advisories/new).
...
In scope: anything in `semitexa/weave` that lets a request, a job or a message do
